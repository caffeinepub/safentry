      ...
      {showForm && (
        ...
        >
          ...
          <input
            ...
            className="w-full border border-border rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-ring bg-card text-foreground"
          />
          <div className="grid grid-cols-2 gap-2">
            <input
              ...
              maxLength={11}
              className="w-full border border-border rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-ring font-mono"
            />
            <input
              type="text"
              value={relationship}
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-1.5 rounded-lg text-xs font-medium border border-border text-foreground/70 hover:bg-muted/40 transition-colors"
            >
              İptal
            </button>
            <button
